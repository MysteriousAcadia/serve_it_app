    ...
    return SafeArea(
      child: Column(
        ...
        children: <Widget>[
          ...
          generateOptions("Edit Profile", Constants.cardColors[3]),
          ...
          generateOptions("Privacy policy", Constants.cardColors[4]),
          generateOptions("Terms of Service",Constants.cardColors[5]),
        ],
      ),
    );
  }
